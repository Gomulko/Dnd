...
const STEPS: { label: string; path: string }[] = [
  { label: "Koncept",   path: "/kreator-goscia/koncept" },
  { label: "Rasa",      path: "/kreator-goscia/rasa" },
  { label: "Klasa",     path: "/kreator-goscia/klasa" },
  { label: "Cechy",     path: "/kreator-goscia/cechy" },
  { label: "Tło",       path: "/kreator-goscia/tlo" },
  { label: "Ekwipunek", path: "/kreator-goscia/ekwipunek" },
  { label: "Magia",     path: "/kreator-goscia/magia" },
  { label: "Gotowe",    path: "/kreator-goscia/gotowe" },
];
...
export default function GuestStepper({ currentStep, maxReachedStep }: Props) {
  return (
    <div
      style={{
        display: "flex",
