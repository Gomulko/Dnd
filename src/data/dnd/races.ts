    ...
    subraces: [
      {
        ...
        nameEn: "Black Dragon",
        statBonuses: {},
        traits: [{ name: "Kwas", nameEn: "Acid", description: "Oddech: linia 30×5 stóp, typ obrażeń: kwas. Odporność na kwas.", source: "SRD" }],
      },
      {
        id: "dragonborn-blue",
        name: "Niebieski Smok",
        nameEn: "Blue Dragon",
        statBonuses: {},
        traits: [{ name: "Błyskawica", nameEn: "Lightning", description: "Oddech: linia 30×5 stóp, typ obrażeń: błyskawica. Odporność na błyskawicę.", source: "SRD" }],
      },
      {
        id: "dragonborn-brass",
        name: "Mosiężny Smok",
        nameEn: "Brass Dragon",
        statBonuses: {},
        traits: [{ name: "Ogień", nameEn: "Fire", description: "Oddech: linia 30×5 stóp, typ obrażeń: ogień. Odporność na ogień.", source: "SRD" }],
      },
      {
        id: "dragonborn-bronze",
        name: "Brązowy Smok",
      ...
      },
      {
        ...
        nameEn: "Gold Dragon",
        statBonuses: {},
        traits: [{ name: "Ogień", nameEn: "Fire", description: "Oddech: stożek 15 stóp, typ obrażeń: ogień. Odporność na ogień.", source: "SRD" }],
      },
      {
        id: "dragonborn-green",
        name: "Zielony Smok",
        nameEn: "Green Dragon",
        statBonuses: {},
        traits: [{ name: "Trucizna", nameEn: "Poison", description: "Oddech: stożek 15 stóp, typ obrażeń: trucizna. Odporność na truciznę.", source: "SRD" }],
      },
      {
        id: "dragonborn-red",
        name: "Czerwony Smok",
      ...
      {
        id: "dragonborn-silver",
        name: "Srebrny Smok",
        nameEn: "Silver Dragon",
        statBonuses: {},
        traits: [{ name: "Zimno", nameEn: "Cold", description: "Oddech: stożek 15 stóp, typ obrażeń: zimno. Odporność na zimno.", source: "SRD" }],
      },
      {
        id: "dragonborn-white",
        name: "Biały Smok",
    ...
    traits: [
      {
        ...
        description: "Twój typ smoka określa typ obrażeń oddechu i odporność. Wybierz powyżej.",
        source: "SRD",
      },
      {
        name: "Oddech",
